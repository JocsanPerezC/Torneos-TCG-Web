...
const entries = [
  ['1', 'Lina Rojas', 'Fuerza: 28', '11'],
  ['2', 'Marco Vega', 'Fuerza: 24', '9'],
  ['3', 'Sofía Mora', 'Fuerza: 21', '8'],
  ['4', 'Tomás León', 'Fuerza: 18', '6'],
];
const metrics = [
  ['Ronda actual', '2 de 3'],
  ['Mesas activas', '4'],
...
export function StandingsPreview() {
  return (
    <section
      aria-label="Vista previa del panel del torneo"
      ...
      <div className="rounded-3xl bg-gradient-to-br from-[#BFE3F5] via-[#2660A4] to-[#14385E] p-4 sm:p-8">
        <Card className="border-white/70 bg-white shadow-xl shadow-[#14385E]/25">
          <CardHeader className="flex-row items-center justify-between border-b border-border pb-4">
            <div>
              <p className="text-xs font-semibold tracking-[.14em] text-accent">PANEL DEL TORNEO</p>
              <CardTitle className="mt-1 text-xl text-foreground">Commander de sábado</CardTitle>
            </div>
          ...
          <CardContent className="p-0">
            ...
            <div className="flex items-center justify-between px-5 pb-3 pt-5">
              ...
              <span className="text-xs text-muted-foreground">Actualizada hace un momento</span>
            </div>
            ...
            {entries.map(([position, name, detail, points]) => (
              <div
                key={name}
              ...
              >
                ...
                <span className="hidden text-muted-foreground sm:block">{detail}</span>
