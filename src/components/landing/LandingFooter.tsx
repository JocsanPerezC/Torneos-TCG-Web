  ...
  return (
    <footer className="bg-[#5B1FE0] text-white">
      <div className="mx-auto flex max-w-6xl flex-wrap items-center justify-center gap-x-5 gap-y-3 px-5 py-10 text-center text-base font-bold">
        <a href="#como-funciona">Cómo funciona</a><a href="#preguntas">Preguntas frecuentes</a><a href="/login">Iniciar sesión</a>
        <span className="w-full text-sm font-medium text-white/70">Copyright © 2026 Jocsan Pérez Coto</span>
