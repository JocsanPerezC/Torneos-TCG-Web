    ...
    return (
      <main className="flex min-h-screen items-center justify-center bg-slate-950 p-6 text-slate-100">
        <section className="w-full max-w-md rounded-xl border border-slate-700 bg-slate-900 p-6 text-center shadow-xl">
          ...
          <p className="mt-2 text-sm text-slate-300">Actualiza la página para intentarlo de nuevo.</p>
          <button className="mt-5 rounded-lg bg-amber-400 px-4 py-2 font-bold text-slate-950 hover:bg-amber-300" onClick={() => window.location.reload()}>
            Actualizar página
          </button>
        </section>
      </main>
