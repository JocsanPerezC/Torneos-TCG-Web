...
function GoogleIcon() {
  return (
    <svg aria-hidden="true" className="h-5 w-5" viewBox="0 0 24 24">
      ...
      <path
        fill="#34A853"
        d="M12 21.75c2.62 0 4.82-.87 6.43-2.35l-3.14-2.79c-.87.58-1.99.92-3.29.92-2.53 0-4.67-1.71-5.44-4.01H3.32v2.88A9.72 9.72 0 0 0 12 21.75Z"
      />
      <path
        fill="#FBBC05"
        d="M6.56 13.52a5.84 5.84 0 0 1 0-3.76V6.88H3.32a9.74 9.74 0 0 0 0 9.52l3.24-2.88Z"
      />
      <path
        fill="#EA4335"
        d="M12 5.75c1.43 0 2.71.49 3.72 1.45l2.79-2.79C16.81 2.82 14.62 1.75 12 1.75A9.72 9.72 0 0 0 3.32 7.1l3.24 2.88c.77-2.3 2.91-4.23 5.44-4.23Z"
      />
    </svg>
  );
}
